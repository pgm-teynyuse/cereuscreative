<template>
  <div
    class="absolute inset-0 -z-10 h-full w-full bg-lightgreen bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:14px_24px]"
  >
    <div
      class="absolute left-0 right-0 top-0 -z-10 m-auto h-[310px] w-[310px] rounded-full bg-darkgreen opacity-20 blur-[100px]"
    ></div>
  </div>
  <div class="w-full h-svh flex justify-center items-center text-center">
